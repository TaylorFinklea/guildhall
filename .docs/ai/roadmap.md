...
- [x] Suite rename (Conductor→Undertake, Bursar→Musterroll, Hindsight→Afterfact,
      Warden→Cautionlight) fully complete: `guildhall-722` epic closed 2026-07-25
      after `conductor-043` cross-repo gate fix + accepted live-gate review
      (decisions.md `[2026-07-25]`). Undertake dispatch resumed; no rename work
      remains open.
